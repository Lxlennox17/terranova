...
public class ModOverworldBiomeBuilder {
    ...
    public VanillaBiomeParameters() {
        ...
        this.commonBiomes = new RegistryKey[][] {
                ...
                {BiomeKeys.PLAINS, BiomeKeys.PLAINS, BiomeKeys.FOREST, BiomeKeys.TAIGA, ModBiomes.REDWOOD_FOREST},
                {BiomeKeys.FLOWER_FOREST, BiomeKeys.PLAINS, BiomeKeys.FOREST, ModBiomes.LAVENDER_FIELDS,ModBiomes.SHADOW_FOREST},
    ...
    public void addBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters) {
